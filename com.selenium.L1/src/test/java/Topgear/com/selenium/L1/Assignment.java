...
public class Assignment {
	...
	void test2() {
		...
		/*
		 * FileWriter f; try { f = new FileWriter("text.txt"); BufferedWriter b=new
		 * BufferedWriter(f); WebElement
		 * w=driver.findElement(By.xpath("//*[@id=\"tab-description\"]/ul/li[5]"));
		 * String s=w.getText(); b.write(s); f.close(); System.out.println(s);
		 * 
